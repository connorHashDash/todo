...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _todoCards_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todoCards.js */ \"./src/todoCards.js\");\n/* harmony import */ var _topbar_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./topbar.js */ \"./src/topbar.js\");\n/* harmony import */ var _seeAllLogic_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./seeAllLogic.js */ \"./src/seeAllLogic.js\");\n/* harmony import */ var _tabLogic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tabLogic.js */ \"./src/tabLogic.js\");\n/* harmony import */ var _ElementMaker_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ElementMaker.js */ \"./src/ElementMaker.js\");\n/* harmony import */ var _ProjLogic_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ProjLogic.js */ \"./src/ProjLogic.js\");\n/* harmony import */ var _projectArray_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projectArray.js */ \"./src/projectArray.js\");\n// file is improperly named, it is the hub file for all the logic used in the app\n\n\n\n\n\n\n\n\n\n\nlet form = document.getElementById('form')\nlet log = console.log\n\nlet tabGet = (() => {\n  let topBar = document.getElementById('topnav');\n  \n  return {topBar}\n})()\n\n\nlet formGet = () => {\n  let Name = document.getElementsByName('titleInput')[0].value\n  let Desc = document.getElementsByName('desc')[0].value\n  let dueDate = document.getElementsByName('dueDate')[0].value\n  let button = document.getElementsByName('button')\n  return {form, Name, Desc, dueDate, button}\n}\n\nlet active = false;\n\nlet Logic = (() => {\n  let i = 0\n  form.addEventListener('submit', (e) => {\n    e.preventDefault();\n    if (!active == false) return\n    _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0][i + 1] = formGet();\n    (0,_todoCards_js__WEBPACK_IMPORTED_MODULE_0__.toDoItem)(_projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0][i + 1].Name, _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0][i + 1].Desc, _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0][i + 1].dueDate);\n    form.reset();\n  })\n\n  let homeTab = (() => {\n    _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0] = []\n    ;(0,_topbar_js__WEBPACK_IMPORTED_MODULE_1__.tabMaker)(`Home`, 0);\n    _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[0][0] = (0,_tabLogic_js__WEBPACK_IMPORTED_MODULE_3__.tabObj)(`Home`, 0);\n  })()\n})()\n\n// The see all projects button underneath the form\nlet seeAll = document.getElementById('seeAllDiv')\n\n\nlet display = document.getElementById('display')\nseeAll.addEventListener('click', () => {\n  if (active == false){\n    display.style.flexDirection = 'column';\n    active = true;\n    (0,_seeAllLogic_js__WEBPACK_IMPORTED_MODULE_2__.clearDisplay)()\n    for (let i = 0; i < _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr.length; i++){\n      display.appendChild((0,_seeAllLogic_js__WEBPACK_IMPORTED_MODULE_2__.populateSeeAllDiv)(_projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[i][0].name, _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[i][0].position + 1).container)\n    }\n    display.appendChild((0,_seeAllLogic_js__WEBPACK_IMPORTED_MODULE_2__.addProjButton)().container)\n    return\n  }else if (active == true){\n    active = false;\n    display.style.flexDirection = 'null'\n    ;(0,_seeAllLogic_js__WEBPACK_IMPORTED_MODULE_2__.clearDisplay)()\n    return\n  }\n})\n\nlet todoPopulate = (position) => {\n  for (let t = 0; t < _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[position].length; t++){\n    (0,_todoCards_js__WEBPACK_IMPORTED_MODULE_0__.toDoItem)(_projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[position][t + 1].name, _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[position][t + 1], _projectArray_js__WEBPACK_IMPORTED_MODULE_6__.tabArr[position][t + 1])\n  }\n}\n\n\n\n//# sourceURL=webpack://todo/./src/FormLogic.js?");
